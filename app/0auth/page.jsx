    ...
    <div className="bg-gray-950 lg:mr-170 rounded-4xl lg:mt-50 mt-50 lg:ml-170 m-10 lg:m-20">
      ...
      <div className="flex justify-center">
        ...
        <div className="grid justify-center">
          {/* Logo + Title */}
          <div className="grid justify-center gap-2 items-center lg:gap-4">
            <div className="flex justify-center">
              <img
                src="/st1.png"
                alt="logo"
          ...
          <div className="scale-80 flex justify-center pb-10 pt-4">
            {status === "authenticated" ? (
              <div className="flex flex-col items-center space-y-4">
                <button className="cursor-pointer text-black scale-120 flex gap-2 items-center bg-white px-4 py-2 rounded-lg font-medium text-sm hover:bg-zinc-300 transition-all ease-in duration-200">
                  <svg
                    viewBox="0 0 48 48"
                    xmlns="http://www.w3.org/2000/svg"
                    className="w-6"
